...
sudo systemctl set-property --runtime -- user.slice AllowedCPUs=7,15
sudo systemctl set-property --runtime -- system.slice AllowedCPUs=7,15
sudo systemctl set-property --runtime -- init.scope AllowedCPUs=7,15
