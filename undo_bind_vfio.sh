...
sudo bash -c "echo -n nouveau > /sys/bus/pci/devices/0000:01:00.0/driver_override"
sudo bash -c "echo 0000:01:00.0 > /sys/bus/pci/drivers/nouveau/bind"
sudo bash -c "echo -n snd_hda_intel > /sys/bus/pci/devices/0000:01:00.1/driver_override"
sudo bash -c "echo 0000:01:00.1 > /sys/bus/pci/drivers/snd_hda_intel/bind"
sudo bash -c "echo -n xhci_hcd > /sys/bus/pci/devices/0000:01:00.2/driver_override"
sudo bash -c "echo 0000:01:00.2 > /sys/bus/pci/drivers/xhci_hcd/bind"
sudo bash -c "echo -n nvidia-gpu > /sys/bus/pci/devices/0000:01:00.3/driver_override"
